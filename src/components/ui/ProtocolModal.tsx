...
export function ProtocolModal({ isOpen, onClose, type, protocol, message, imageSrc }: ProtocolModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-surface w-full max-w-md rounded-[40px] overflow-hidden flex flex-col shadow-2xl border border-border/50 animate-in zoom-in-95 duration-300">
                {/* Header */}
